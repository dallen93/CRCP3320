...
<body>
  ...
  <form>
    ...
    <input type="button" value="Rank" onClick="location.href='rank.html'" />
    <input type="button" value="Title" onclick="location.href='title.html'" />
    <input type="button" value="Year" onclick="location.href='year.html'" />
  </form>
